	...
	<HashRouter>
		...
		<Route 
			path={[
				...
				"/places/search/:search/search_field/:search_field/category/:category/person_relation/:person_relation/gender/:gender/(nordic)?/:nordic?",
				"/places/search/:search/search_field/:search_field/category/:category/person_relation/:person_relation/(nordic)?/:nordic?",
				...
				"/places/search/:search/search_field/:search_field/person_relation/:person_relation/gender/:gender/(nordic)?/:nordic?",
				"/places/search/:search/search_field/:search_field/person_relation/:person_relation/(nordic)?/:nordic?",
				"/places/search/:search/person_relation/:person_relation/(nordic)?/:nordic?",
				"/places/search/:search/category/:category/person_relation/:person_relation/gender/:gender/(nordic)?/:nordic?",
				"/places/search/:search/category/:category/person_relation/:person_relation/(nordic)?/:nordic?",
				...
				"/places/:place_id([0-9]+)/search/:search/search_field/:search_field/category/:category/(nordic)?/:nordic?",
				"/places/:place_id([0-9]+)/search/:search/search_field/:search_field/(nordic)?/:nordic?",
				"/places/:place_id([0-9]+)/category/:category/gender/:gender/(nordic)?/:nordic?",
				"/places/:place_id([0-9]+)/category/:category/(nordic)?/:nordic?",
				"/places/:place_id([0-9]+)/gender/:gender/(nordic)?/:nordic?",
				"/places/category/:category/person_relation/:person_relation/gender/:gender/(nordic)?/:nordic?",
				"/places/category/:category/person_relation/:person_relation/(nordic)?/:nordic?",
				"/places/category/:category/gender/:gender/(nordic)?/:nordic?",
				...
				"/records/:record_id/search/:search/search_field/:search_field/category/:category/(nordic)?/:nordic?",
				"/records/:record_id/search/:search/search_field/:search_field/(nordic)?/:nordic?",
